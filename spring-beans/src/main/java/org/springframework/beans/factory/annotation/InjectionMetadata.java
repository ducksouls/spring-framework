...
public class InjectionMetadata {
    ...
    public void checkConfigMembers(RootBeanDefinition beanDefinition) {
        ...
        for (InjectedElement element : this.injectedElements) {
            Member member = element.getMember();//java 反射的类
        ...
        protected final void checkResourceType(Class<?> resourceType) {
            if (this.isField) {
                ...
                if (!(resourceType.isAssignableFrom(fieldType) || fieldType.isAssignableFrom(resourceType))) {
                    throw new IllegalStateException("Specified field type [" + fieldType + "] is incompatible with " +
                ...
                if (!(resourceType.isAssignableFrom(paramType) || paramType.isAssignableFrom(resourceType))) {
                    throw new IllegalStateException("Specified parameter type [" + paramType + "] is incompatible " +
							"with resource type [" + resourceType.getName() + "]");
                }
            }
        }
