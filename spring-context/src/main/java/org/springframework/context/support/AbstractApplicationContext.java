...
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext {
    ...
    ApplicationEventMulticaster getApplicationEventMulticaster() throws IllegalStateException {
        if (this.applicationEventMulticaster == null) {
            throw new IllegalStateException("ApplicationEventMulticaster not initialized - " + "call 'refresh' before" +
                    " " +
                    "multicasting events via the context: " + this);
        }
    ...
    LifecycleProcessor getLifecycleProcessor() throws IllegalStateException {
        if (this.lifecycleProcessor == null) {
            throw new IllegalStateException("LifecycleProcessor not initialized - " + "call 'refresh' before invoking" +
                    " " +
                    "lifecycle methods via the context: " + this);
        }
    ...
    public void refresh() throws BeansException, IllegalStateException {
        synchronized (this.startupShutdownMonitor) {
            ...
            try {
                ...
                // 注册beanPostProcessor, 比如autowiredAnnotation处理, 可以是spring的也可以是自己的
    ...
    protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
        ...
        // 是在xml形式中 auto-wired 属性byType才会起作用
        // @Autowired ≠ 自动绑定（Autowiring）
        logger.info("autowiring 不等于 @Autowired");
        ...
        logger.info("对beanFactory的一些准备工作做完了....");
    }
    ...
    private MessageSource getMessageSource() throws IllegalStateException {
        if (this.messageSource == null) {
            throw new IllegalStateException("MessageSource not initialized - " + "call 'refresh' before accessing " +
                    "messages via the context: " + this);
        }
