...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
    ...
    public ClassPathBeanDefinitionScanner(BeanDefinitionRegistry registry, boolean useDefaultFilters,
        ...
        this(registry, useDefaultFilters, environment, (registry instanceof ResourceLoader ?
				(ResourceLoader) registry : null));
    }
    ...
    protected void postProcessBeanDefinition(AbstractBeanDefinition beanDefinition, String beanName) {
        // 给beanDefinition增强, 直到最后我们new对象前, 我们操作的对象都是beanDefinition
        beanDefinition.applyDefaults(this.beanDefinitionDefaults);
        if (this.autowireCandidatePatterns != null) {
            beanDefinition.setAutowireCandidate(PatternMatchUtils.simpleMatch(this.autowireCandidatePatterns,
					beanName));
        }
    }
    ...
    protected boolean checkCandidate(String beanName, BeanDefinition beanDefinition) throws IllegalStateException {
        ...
        throw new ConflictingBeanDefinitionException("Annotation-specified bean name '" + beanName + "' for bean " +
				"class [" + beanDefinition.getBeanClassName() + "] conflicts with existing, " + "non-compatible bean " +
				"definition of same name and class [" + existingDef.getBeanClassName() + "]");
    }
